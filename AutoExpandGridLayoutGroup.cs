    ...
    public class AutoExpandGridLayoutGroup : LayoutGroup
    {
        ...
        void Update() {
            if (constraint == Constraint.Flexible && FlexibleSize) {
                ...
                m_CellSize = new Vector2(rectTransform.rect.width / m_ConstraintCount - 0.001f,
                    rectTransform.rect.height / m_ConstraintCount - 0.001f);
            }
        }
#endif
        ...
        void SetCellsAlongAxis(int axis) {
            ...
            for (int i = 0; i < rectChildren.Count; i++) {
                ...
                if (FlexibleSize) {
                    ...
                    SetChildAlongAxis(rectChildren[i], 1, startOffset.y + (realsize + spacing[1]) * positionY,
                        realsize);
                }
                else
